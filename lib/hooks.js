...
*/
    ...
    event: function(ev, msg){
		...
		case 'play_game': //event on button play
			gradle.showInter();
			break;	
		...
		case 'button_more': //event on button share
			gradle.event('btn_more');
			break;
		
		case 'button_privacy': //event on button share
			gradle.event('btn_privacy');
			break;	
			
		case 'button_exit': //event on button share
