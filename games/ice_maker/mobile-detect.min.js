...
! function(a, b) {
    ...
    function j(a, c, e) {
        if (a.mobile === b) {
            var f, g, h;
            return (f = d(m.phones, c)) ? (a.mobile = a.phone = f, a.tablet = null, void 0) : (g = d(m.tablets, c)) ? (a.mobile = a.tablet = g, a.phone = null, void 0) : (i(c) ? (h = k.isPhoneSized(e), h === b ? a.mobile = a.tablet = a.phone = r : h ? (a.mobile = a.phone = p, a.tablet = null) : (a.mobile = a.tablet = q, a.phone = null)) : a.mobile = a.tablet = a.phone = null, void 0)
        }
    }
    ...
    l = "isArray" in Array ? Array.isArray : function(a) {
        ...
        function() {
            ...
            for (a in m.props)
                if (o.call(m.props, a)) {
                    for (b = m.props[a], l(b) || (b = [b]), f = b.length, e = 0; f > e; ++e) d = b[e], g = d.indexOf("[VER]"), g >= 0 && (d = d.substring(0, g) + "([\\w._\\+]+)" + d.substring(g + 5)), b[e] = new RegExp(d, "i");
                    m.props[a] = b
                }
    ...
    if ("undefined" != typeof module && module.exports) a.isPhoneSized = function() {}, module.exports = a;
    else {
        if ("undefined" == typeof window) throw new Error("unknown environment");
