...
function drawScoreboard() {
	...
	if (gameState === 0) {
		...
		renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2 + gdy - 155 * settings.scale, 100, "#CCCCCC", "Color Hexagon");
		renderText(trueCanvas.width / 2 + gdx + 5 * settings.scale, h, fontSize, "rgb(204,204,204)", 'Play!');
...
function setMainMenu() {
	...
	$('#restartBtn').hide();
	if ($("#pauseBtn").replace(/^.*[\\\/]/, '') == "btn_pause.png") {
		$("#pauseBtn").attr("src","./images/btn_resume.png");
	} else {
