...
function initSplash() {
    window.famobi_onPauseRequested = function() {
        Howler.mute(), music.pause(), famobiPauseActive = !0
    }, window.famobi_onResumeRequested = function() {
        muted || "pause" == gameState || (Howler.unmute(), music.play()), famobiPauseActive = !1
    }, oGameData.cupId = saveDataHandler.getCurCupId(), oGameData.gameId = saveDataHandler.getCurGameId();
    var t = saveDataHandler.getUserId();
    1234 == t ? firstRun = !0 : (firstRun = !1, oGameData.userId = t), controlState = saveDataHandler.getControlState(), 1 != audioType || muted || (playMusic(), hasFocus || music.pause()), initStartScreen()
}
...
function initStartScreen() {
    ...
    1 == audioType && music.fade(music.volume(), .5, 500), userInput.removeHitArea("moreGames"), background = new Elements.Background;
    var a = {
    ...
    userInput.addHitArea("playFromStart", butEventHandler, null, "image", a), userInput.addHitArea("moreGames", butEventHandler, null, "image", e), userInput.addHitArea("credits", butEventHandler, null, "image", s);
    var i = new Array(e, s, a);
    if (!firstRun) {
        var o = {
            oImgData: assetLib.getData("uiButs"),
            aPos: [-55, -140],
        ...
        userInput.addHitArea("changeCountryFromStart", butEventHandler, null, "image", o);
        var h = {
            oImgData: assetLib.getData("uiButs"),
            aPos: [-54, -54],
            align: [1, 1],
        ...
        userInput.addHitArea("cupsFromStart", butEventHandler, null, "image", h), i.push(o, h)
    }
    addMuteBut(i), panel = new Elements.Panel(gameState, i), panel.startTween1(), previousTime = (new Date).getTime(), updateStartScreenEvent()
}
...
function addMuteBut(t) {
    if (1 == audioType) {
        ...
        userInput.addHitArea("mute", butEventHandler, null, "image", e), t.push(e)
    }
}
...
function initCreditsScreen() {
    ...
    userInput.addHitArea("backFromCredits", butEventHandler, null, "image", a), userInput.addHitArea("resetData", butEventHandler, null, "image", e);
    var s = new Array(a, e);
    if (isMobile) {
        var i, o;
        0 == controlState ? (i = {
            ...
            noMove: !0
        }), userInput.addHitArea("control0FromCredits", butEventHandler, null, "image", i), userInput.addHitArea("control1FromCredits", butEventHandler, null, "image", o), s.push(i, o)
    }
    addMuteBut(s), panel = new Elements.Panel(gameState, s), panel.startTween1(), previousTime = (new Date).getTime(), updateCreditsScreenEvent()
}
...
function initChooseCountry() {
    ...
    for (var a = new Array(t), e = assetLib.getData("uiElements"), s = e.oData.oAtlasData[oImageIds.countryBut].width, i = e.oData.oAtlasData[oImageIds.countryBut].height, o = 0; o < countryFlags.aIds.length; o++) {
        var h = canvas.width / 2 - s / 2 + 120 * (o % 4 - 2) + 60,
            r = canvas.height / 2 - i / 2 + 90 * (Math.floor(o / 4) - 2.5) + 45;
    ...
    addMuteBut(a), panel = new Elements.Panel(gameState, a), panel.startTween1(), previousTime = (new Date).getTime(), updateChooseCountryScreenEvent()
}
...
function initMapScreen() {
    ...
    userInput.addHitArea("backFromMap", butEventHandler, null, "image", s), userInput.addHitArea("playFromMap", butEventHandler, null, "image", i);
    var o = new Array(s, i);
    if (10 == oGameData.cupId && 6 == oGameData.gameId) {
        ...
        userInput.addHitArea("resetDataFromMap", butEventHandler, null, "image", h), o.push(h)
    }
    addMuteBut(o), panel = new Elements.Panel(gameState, o), panel.startTween1(), previousTime = (new Date).getTime(), updateMapScreenEvent()
}
...
function initGameIntro() {
    ...
    10 == oGameData.cupId && 6 == oGameData.gameId && (oGameData.cupId = 9, oGameData.gameId = 5), oGameData.enemyId = countryFlags.getIdFromISO(aEnemyCountries[oGameData.cupId][oGameData.gameId]), oGameData.enemyId == oGameData.userId && (oGameData.enemyId = countryFlags.getIdFromISO(spareEnemyCountry));
    var a = {
            oImgData: assetLib.getData("uiButs"),
            aPos: [30, -32],
            align: [0, 1],
    ...
    userInput.addHitArea("backFromGameIntro", butEventHandler, null, "image", a), userInput.addHitArea("playFromGameIntro", butEventHandler, null, "image", e);
    var s = new Array(a, e);
    addMuteBut(s), panel = new Elements.Panel(gameState, s), panel.startTween1(), previousTime = (new Date).getTime(), updateGameIntroScreenEvent()
}

function initGame(t) {
    "undefined" == typeof t && (t = !1), gameState = "game", playSound("gameStart");
    try {
    ...
    playSound("cheer" + Math.floor(4 * Math.random())), 1 == audioType && music.fade(music.volume(), .1, 1e3), oGameData.userScore = 0, oGameData.enemyScore = 0, justWonCup = !1, background = new Elements.Background;
    var e = new Array;
    if (firstRun) {
        var s = {
            oImgData: assetLib.getData("uiButs"),
        ...
        userInput.addHitArea("tickFromTut", butEventHandler, null, "image", s), e.push(s)
    } else {
        ...
        userInput.addHitArea("pause", butEventHandler, null, "image", i), e.push(i)
    }
    addMuteBut(e), panel = new Elements.Panel(gameState, e), panel.startTween1(), firstRun && panel.startTut(), tableTop = new Elements.TableTop, userBat = new Elements.UserBat, enemyBat = new Elements.EnemyBat, ball = new Elements.Ball, previousTime = (new Date).getTime(), updateGameEvent()
}
...
function initPause() {
    ...
    userInput.addHitArea("playFromPause", butEventHandler, null, "image", a), userInput.addHitArea("restartFromPause", butEventHandler, null, "image", e), userInput.addHitArea("quitFromPause", butEventHandler, null, "image", s);
    var i = new Array(a, e, s);
    if (isMobile) {
        var o, h;
        0 == controlState ? (o = {
            oImgData: assetLib.getData("uiButs"),
            ...
            id: oImageIds.control1OnBut,
            noMove: !0
        }), userInput.addHitArea("control0FromPause", butEventHandler, null, "image", o), userInput.addHitArea("control1FromPause", butEventHandler, null, "image", h), i.push(o, h)
    }
    panel = new Elements.Panel(gameState, i), panel.startTween1(), previousTime = (new Date).getTime(), background = new Elements.Background, updatePauseEvent()
}
...
function resumeGame() {
    ...
    var a = new Array(t);
    addMuteBut(a), panel = new Elements.Panel(gameState, a), panel.startTween1(), previousTime = (new Date).getTime(), updateGameEvent()
}
...
function butEventHandler(t, a) {
    switch (t) {
        ...
        case "resetData":
            ...
            var s = saveDataHandler.getUserId();
            1234 == s ? firstRun = !0 : (firstRun = !1, oGameData.userId = s), controlState = saveDataHandler.getControlState(), initStartScreen();
            break;
        case "resetDataFromMap":
            playSound("hit" + Math.floor(6 * Math.random())), userInput.removeHitArea("resetDataFromMap"), userInput.removeHitArea("backFromMap"), userInput.removeHitArea("playFromMap"), saveDataHandler.resetData(), oGameData.cupId = saveDataHandler.getCurCupId(), oGameData.gameId = saveDataHandler.getCurGameId();
            var s = saveDataHandler.getUserId();
            1234 == s ? firstRun = !0 : (firstRun = !1, oGameData.userId = s), controlState = saveDataHandler.getControlState(), initMapScreen();
            break;
        ...
        case "playFromStart":
            ...
            break;
        case "countryChoice":
            playSound("hit" + Math.floor(6 * Math.random())), userInput.removeHitArea("backFromChooseCountry"), userInput.removeHitArea("countryChoice"), oGameData.userId = countryFlags.aIds[a.id], saveDataHandler.setUserId(oGameData.userId), saveDataHandler.saveData(), firstRun ? initMapScreen() : initGameIntro();
            break;
        case "backFromChooseCountry":
            playSound("hit" + Math.floor(6 * Math.random())), userInput.removeHitArea("backFromChooseCountry"), userInput.removeHitArea("countryChoice"), initStartScreen();
            break;
        case "backFromMap":
        ...
        case "playFromGameIntro":
            playSound("hit" + Math.floor(6 * Math.random())), userInput.removeHitArea("backFromGameIntro"), userInput.removeHitArea("playFromGameIntro"), initGame();
            break;
        case "tickFromTut":
            playSound("hit" + Math.floor(6 * Math.random())), userInput.removeHitArea("tickFromTut"), panel.aButs = new Array, userInput.addHitArea("gameTouch", butEventHandler, {
                isDraggable: !0,
                multiTouch: !0
            }, "rect", {
                aRect: [0, 50, canvas.width, canvas.height]
            ...
            userInput.addHitArea("pause", butEventHandler, null, "image", i), panel.aButs.push(i), addMuteBut(panel.aButs), firstRun = !1;
            break;
        case "gameTouch":
            a.isDown && !a.isBeingDragged ? (swipeState = 1, startTouchY = a.y - userBat.targY) : 1 == swipeState && a.isBeingDragged ? (userBat.targX = a.x, 0 == controlState ? userBat.targY = a.y : userBat.targY = a.y - startTouchY) : 1 == swipeState && (swipeState = 0);
            break;
        ...
        case "nextFromGameComplete":
            ...
            break;
        case "mute":
            if (playSound("hit" + Math.floor(6 * Math.random())), toggleMute(), muted) {
...
function updateScore(t) {
    panel.cardTween(t), rallyHits <= 4 && Math.random() > .5 ? playSound("cheer" + Math.floor(2 * Math.random())) : rallyHits > 4 && rallyHits <= 7 ? playSound("cheer" + (1 + Math.floor(2 * Math.random()))) : rallyHits > 7 && rallyHits <= 10 ? playSound("cheer" + (2 + Math.floor(2 * Math.random()))) : rallyHits > 10 && playSound("cheer" + (3 + Math.floor(2 * Math.random()))), "user" == t ? (oGameData.userScore++, playSound("userPoint"), (oGameData.userScore >= 11 && oGameData.enemyScore <= oGameData.userScore - 2 || 99 == oGameData.userScore) && initGameComplete()) : (oGameData.enemyScore++, playSound("enemyPoint"), (oGameData.enemyScore >= 11 && oGameData.userScore <= oGameData.enemyScore - 2 || 99 == oGameData.enemyScore) && initGameComplete())
}

function initGameComplete() {
    gameState = "gameComplete", 1 == audioType && music.fade(music.volume(), .5, 500), userInput.removeHitArea("pause"), userInput.removeHitArea("gameTouch");
    try {
    ...
    if (oGameData.userScore > oGameData.enemyScore) {
        ...
        try {
            window.famobi_analytics.trackEvent(famobi_analytics.EVENT_LEVELSCORE, {
                levelName: (6 * oGameData.cupId + oGameData.gameId).toString(),
                levelScore: oGameData.userScore - oGameData.enemyScore
            })
        } catch (t) {}
        playSound("winGame"), oGameData.gameId++, oGameData.gameId >= 6 && (oGameData.cupId++, justWonCup = !0, oGameData.cupId > 9 ? (oGameData.cupId = 10, oGameData.gameId = 6) : oGameData.gameId = 0), saveDataHandler.setGameData(oGameData), saveDataHandler.saveData(), e = {
            oImgData: assetLib.getData("uiButs"),
            aPos: [0, 0],
            align: [.5, .85],
            id: oImageIds.playBut
    ...
    userInput.addHitArea("nextFromGameComplete", butEventHandler, null, "image", e);
    var s = new Array(a, e);
    addMuteBut(s), panel = new Elements.Panel(gameState, s), panel.startTween1(), aEffects = new Array, previousTime = (new Date).getTime(), updateGameComplete()
}

function addFirework(t, a, e) {
    if ("undefined" == typeof e && (e = 1), !(aEffects.length > 10)) {
        var s = new Elements.Firework;
        s.x = t, s.y = a, s.scaleX = s.scaleY = e, aEffects.push(s)
    }
}
...
function updateSplashScreenEvent() {
    if ("splash" == gameState) {
        if (delta = getDelta(), splashTimer += delta, splashTimer > 2.5) return 1 != audioType || muted || (playMusic(), hasFocus || music.pause()), void initStartScreen();
...
function getCentreFromTopLeft(t, a, e) {
    var s = new Array;
    return s.push(t[0] + a.oData.spriteWidth / 2 * e), s.push(t[1] + a.oData.spriteHeight / 2 * e), s
}
...
function initLangSelect() {
    for (var t, a, e, s = 10, i = 0, o = 0, h = 1, r = 0; r < aLangs.length && (t = preAssetLib.getData("lang" + aLangs[r]), (r + 1) * (t.img.width * h) + (r + 2) * s < canvas.width); r++) i++;
    o = Math.ceil(aLangs.length / i);
    for (var r = 0; r < aLangs.length; r++) {
        t = preAssetLib.getData("lang" + aLangs[r]), a = canvas.width / 2 - i / 2 * (t.img.width * h) - (i - 1) / 2 * s, a += r % i * (t.img.width * h + s), e = canvas.height / 2 - o / 2 * (t.img.height * h) - (o - 1) / 2 * s, e += Math.floor(r / i) % o * (t.img.height * h + s), ctx.drawImage(t.img, 0, 0, t.img.width, t.img.height, a, e, t.img.width * h, t.img.height * h);
        var n = {
            oImgData: t,
            aPos: [a + t.img.width * h / 2, e + t.img.height * h / 2],
            scale: h,
            id: "none",
            noMove: !0
        };
...
function toggleMute() {
    muted = !muted, 1 == audioType ? muted ? (Howler.mute(!0), music.pause()) : (Howler.mute(!1), playMusic(), "game" == gameState ? music.volume(.1) : music.volume(.5)) : 2 == audioType && (muted ? music.pause() : playMusic())
}
var Utils;
! function(t) {
    var a = function() {
        function t(t, a, e, s, i, o) {
            "undefined" == typeof o && (o = !0), this.oAssetData = {}, this.assetsLoaded = 0, this.textData = {}, this.spinnerRot = 0, this.totalAssets = a.length, this.showBar = o;
            for (var h = 0; h < a.length; h++) a[h].file.indexOf(".json") != -1 ? this.loadJSON(a[h]) : this.loadImage(a[h]);
        ...
        return t.prototype.render = function() {
            ...
            for (var e = 0; e < a.length; e++) a[e].file.indexOf(".json") != -1 ? this.loadJSON(a[e]) : this.loadImage(a[e])
        }, t.prototype.loadJSON = function(t) {
            var a = this,
                e = new XMLHttpRequest;
            e.open("GET", t.file, !0), e.onreadystatechange = function() {
                4 == e.readyState && 200 == e.status && (a.textData[t.id] = JSON.parse(e.responseText), ++a.assetsLoaded, a.checkLoadComplete())
            }, e.send(null)
            ...
            for (var a = new Array, e = "", s = "", i = 0, o = t.lastIndexOf("."), h = !0; h;) o--, 0 == i && this.isNumber(t.charAt(o)) ? e = t.charAt(o) + e : 0 == i && e.length > 0 && "x" == t.charAt(o) ? (o--, i = 1, s = t.charAt(o) + s) : 1 == i && this.isNumber(t.charAt(o)) ? s = t.charAt(o) + s : 1 == i && s.length > 0 && "_" == t.charAt(o) ? (h = !1, a = [parseInt(s), parseInt(e)]) : (h = !1, a = [0, 0]);
            return a
...
! function(t) {
    var a = function() {
        function t(t, a, e, s) {
            this.x = 0, this.y = 0, this.rotation = 0, this.radius = 10, this.removeMe = !1, this.frameInc = 0, this.animType = "loop", this.offsetX = 0, this.offsetY = 0, this.scaleX = 1, this.scaleY = 1, this.alpha = 1, this.oImgData = t, this.oAnims = this.oImgData.oData.oAnims, this.fps = a, this.radius = e, this.animId = s, this.centreX = Math.round(this.oImgData.oData.spriteWidth / 2), this.centreY = Math.round(this.oImgData.oData.spriteHeight / 2)
        }
        return t.prototype.updateAnimation = function(t) {
            ...
            switch ("undefined" == typeof e && (e = !0), this.animId = a, this.animType = t, e && this.resetAnim(), t) {
                case "loop":
                    break;
                case "once":
            ...
            if (t.save(), t.translate(this.x, this.y), t.rotate(this.rotation), t.scale(this.scaleX, this.scaleY), t.globalAlpha = this.alpha, null != this.animId) {
                ...
                i = Math.floor(this.fixedFrame / (this.oImgData.img.width / this.oImgData.oData.spriteWidth)) * this.oImgData.oData.spriteHeight;
            t.drawImage(this.oImgData.img, s, i, this.oImgData.oData.spriteWidth, this.oImgData.oData.spriteHeight, -this.centreX + this.offsetX, -this.centreY + this.offsetY, this.oImgData.oData.spriteWidth, this.oImgData.oData.spriteHeight), t.restore()
...
! function(t) {
    var a = function() {
        function t(t, a, e) {
            "undefined" == typeof e && (e = 0), this.x = 0, this.y = 0, this.rotation = 0, this.radius = 10, this.removeMe = !1, this.offsetX = 0, this.offsetY = 0, this.scaleX = 1, this.scaleY = 1, this.oImgData = t, this.radius = a, this.setFrame(e)
        }
...
! function(t) {
    var a = function() {
        ...
        return t.prototype.hitDown = function(t, a, e, s) {
            if (t.preventDefault(), t.stopPropagation(), hasFocus || visibleResume(), !this.pauseIsOn) {
                ...
                for (var o = 0; o < this.aHitAreas.length; o++)
                    if (this.aHitAreas[o].rect) {
                        var h = canvas.width * this.aHitAreas[o].align[0],
                            r = canvas.height * this.aHitAreas[o].align[1];
                        if (a > h + this.aHitAreas[o].area[0] && e > r + this.aHitAreas[o].area[1] && a < h + this.aHitAreas[o].area[2] && e < r + this.aHitAreas[o].area[3]) {
                            if (this.aHitAreas[o].aTouchIdentifiers.push(s), this.aHitAreas[o].oData.hasLeft = !1, !this.aHitAreas[o].oData.isDown) {
                                if (this.aHitAreas[o].oData.isDown = !0, this.aHitAreas[o].oData.x = a, this.aHitAreas[o].oData.y = e, i - this.prevHitTime < 500 && ("game" != gameState || "pause" == this.aHitAreas[o].id) && isBugBrowser) return;
                ...
                for (var i = 0; i < this.aHitAreas.length; i++)
                    if (this.aHitAreas[i].rect) {
                        var o = canvas.width * this.aHitAreas[i].align[0],
                            h = canvas.height * this.aHitAreas[i].align[1];
                        if (a > o + this.aHitAreas[i].area[0] && e > h + this.aHitAreas[i].area[1] && a < o + this.aHitAreas[i].area[2] && e < h + this.aHitAreas[i].area[3]) {
                            for (var r = 0; r < this.aHitAreas[i].aTouchIdentifiers.length; r++) this.aHitAreas[i].aTouchIdentifiers[r] == s && (this.aHitAreas[i].aTouchIdentifiers.splice(r, 1), r -= 1);
                            0 == this.aHitAreas[i].aTouchIdentifiers.length && (this.aHitAreas[i].oData.isDown = !1, this.aHitAreas[i].oData.multiTouch && (this.aHitAreas[i].oData.x = a, this.aHitAreas[i].oData.y = e, this.aHitAreas[i].callback(this.aHitAreas[i].id, this.aHitAreas[i].oData)));
                            break
                        }
                    }
            }
            ...
            t.preventDefault(), t.stopPropagation(), a *= canvasScale, e *= canvasScale;
            for (var i = 0; i < this.aHitAreas.length; i++) this.aHitAreas[i].oData.isDown && (this.aHitAreas[i].oData.isDown = !1, this.aHitAreas[i].aTouchIdentifiers = new Array, this.aHitAreas[i].oData.multiTouch && (this.aHitAreas[i].oData.x = a, this.aHitAreas[i].oData.y = e, this.aHitAreas[i].callback(this.aHitAreas[i].id, this.aHitAreas[i].oData)))
        }, t.prototype.move = function(t, a, e, s, i) {
            if (!this.pauseIsOn && (isMobile || void 0 == userBat || firstRun || (userBat.targX = a * canvasScale, userBat.targY = e * canvasScale), i)) {
                a *= canvasScale, e *= canvasScale;
                for (var o = 0; o < this.aHitAreas.length; o++)
                    if (this.aHitAreas[o].rect) {
                        var h = canvas.width * this.aHitAreas[o].align[0],
                            r = canvas.height * this.aHitAreas[o].align[1];
                        if (a > h + this.aHitAreas[o].area[0] && e > r + this.aHitAreas[o].area[1] && a < h + this.aHitAreas[o].area[2] && e < r + this.aHitAreas[o].area[3]) this.aHitAreas[o].oData.hasLeft = !1, this.aHitAreas[o].oData.isDraggable && !this.aHitAreas[o].oData.isDown && (this.aHitAreas[o].oData.isDown = !0, this.aHitAreas[o].oData.x = a, this.aHitAreas[o].oData.y = e, this.aHitAreas[o].aTouchIdentifiers.push(s), this.aHitAreas[o].oData.multiTouch && this.aHitAreas[o].callback(this.aHitAreas[o].id, this.aHitAreas[o].oData)), this.aHitAreas[o].oData.isDraggable && (this.aHitAreas[o].oData.isBeingDragged = !0, this.aHitAreas[o].oData.x = a, this.aHitAreas[o].oData.y = e, this.aHitAreas[o].callback(this.aHitAreas[o].id, this.aHitAreas[o].oData), this.aHitAreas[o] && (this.aHitAreas[o].oData.isBeingDragged = !1));
                        else if (this.aHitAreas[o].oData.isDown && !this.aHitAreas[o].oData.hasLeft) {
                            for (var n = 0; n < this.aHitAreas[o].aTouchIdentifiers.length; n++) this.aHitAreas[o].aTouchIdentifiers[n] == s && (this.aHitAreas[o].aTouchIdentifiers.splice(n, 1), n -= 1);
            ...
            for (var a = 0; a < this.aKeys.length; a++) t.keyCode == this.aKeys[a].keyCode && (t.preventDefault(), this.aKeys[a].oData.isDown = !0, this.aKeys[a].callback(this.aKeys[a].id, this.aKeys[a].oData))
        }, t.prototype.keyUp = function(t) {
            for (var a = 0; a < this.aKeys.length; a++) t.keyCode == this.aKeys[a].keyCode && (t.preventDefault(), this.aKeys[a].oData.isDown = !1, this.aKeys[a].callback(this.aKeys[a].id, this.aKeys[a].oData))
            ...
            "undefined" == typeof o && (o = !1), null == e && (e = new Object), o && this.removeHitArea(t), i.scale || (i.scale = 1), i.align || (i.align = [0, 0]);
            var h = new Array;
            switch (s) {
                case "image":
                    var r;
                    r = new Array(i.aPos[0] - i.oImgData.oData.oAtlasData[i.id].width / 2 * i.scale, i.aPos[1] - i.oImgData.oData.oAtlasData[i.id].height / 2 * i.scale, i.aPos[0] + i.oImgData.oData.oAtlasData[i.id].width / 2 * i.scale, i.aPos[1] + i.oImgData.oData.oAtlasData[i.id].height / 2 * i.scale), this.aHitAreas.push({
                        id: t,
                        aTouchIdentifiers: h,
                        callback: a,
                        oData: e,
...
! function(t) {
    var a = function() {
        function t() {
            this.x = 0, this.y = 0, this.targY = 0, this.incY = 0, this.renderState = null, this.wallId = 0, this.oImgData = assetLib.getData("background"), this.oGameElementsImgData = assetLib.getData("gameElements"), this.wallId = oGameData.cupId % 5
        }
        return t.prototype.renderGame = function() {
            ...
            var t = this.oGameElementsImgData.oData.oAtlasData[oImageIds["tableBg" + this.wallId]].x,
...
! function(t) {
    var a = function() {
        function t(t, a) {
            this.timer = .3, this.endTime = 0, this.posY = 0, this.largeNumberSpace = 68, this.smallNumberSpace = 17, this.scoreNumberSpace = 15, this.incY = 0, this.flareRot = 0, this.cupFlipInc = 0, this.userCardScale = 1, this.enemyCardScale = 1, this.userBatX = 0, this.userBatY = 0, this.enemyBatX = 0, this.enemyBatY = 0, this.ballX = 0, this.ballY = 0, this.ballHeight = 0, this.oSplashLogoImgData = assetLib.getData("splashLogo"), this.oCountryFlagsImgData = assetLib.getData("countryFlags"), this.oUiElementsImgData = assetLib.getData("uiElements"), this.oLargeNumbersImgData = assetLib.getData("largeNumbers"), this.oSmallNumbersImgData = assetLib.getData("smallNumbers"), this.oScoreNumbersImgData = assetLib.getData("scoreNumbers"), this.oGameElementsImgData = assetLib.getData("gameElements"), this.panelType = t, this.aButs = a, this.cupFlipInc = 0
        }
        return t.prototype.update = function() {
            ...
            switch ("undefined" == typeof t && (t = !0), t || this.addButs(ctx), this.panelType) {
                ...
                case "start":
                    ...
                    var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBats].x,
                    ...
                    var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleBall].x,
                    ...
                    var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].x,
                ...
                case "credits":
                    ...
                    break;
                case "chooseCountry":
                    for (var h = 0; h < countryFlags.aIds.length; h++) {
                        var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.countryBut].x,
                        ...
                        ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, canvas.width / 2 - s / 2 + 120 * (h % 4 - 2) + 60, canvas.height / 2 - i / 2 - 5 * this.posY / (h + 1) + 90 * (Math.floor(h / 4) - 2.5) + 45, s, i);
                        var r = countryFlags.getBData(countryFlags.aIds[h]);
                        ctx.drawImage(this.oCountryFlagsImgData.img, r.bX, r.bY, r.bWidth, r.bHeight, canvas.width / 2 - r.bWidth / 2 + 120 * (h % 4 - 2) + 60, canvas.height / 2 - r.bHeight / 2 - 5 * this.posY / (h + 1) + 90 * (Math.floor(h / 4) - 2.5) + 45, r.bWidth, r.bHeight)
                    }
                    break;
                case "map":
                    var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].x,
                    ...
                    var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.map].x,
                    ...
                    for (var h = 0; h < aMapMarkerPos.length; h++) {
                        var n = canvas.width / 2 + aMapMarkerPos[h][0],
                            m = .45 * canvas.height + aMapMarkerPos[h][1] - this.posY * (1 + h / 2),
                            l = 0;
                        h < oGameData.cupId ? l = 2 : h == oGameData.cupId && (l = 1, this.flare(n, m, .5));
                        var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + l]].x,
                            e = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + l]].y,
                            s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + l]].width,
                            i = this.oUiElementsImgData.oData.oAtlasData[oImageIds["mapMarker" + l]].height;
                        ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, n - s / 2, m - i / 2, s, i);
                        for (var g = (h + 1).toString(), d = 0; d < g.length; d++) {
                            var o = .23,
                                u = parseFloat(g.charAt(d)),
                                c = u * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width,
                                I = Math.floor(u / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                            ctx.drawImage(this.oLargeNumbersImgData.img, c, I, this.oLargeNumbersImgData.oData.spriteWidth, this.oLargeNumbersImgData.oData.spriteHeight, n + (d * this.largeNumberSpace - g.length * this.largeNumberSpace / 2) * o - 2, m - this.oLargeNumbersImgData.oData.spriteHeight / 2 * o, this.oLargeNumbersImgData.oData.spriteWidth * o, this.oLargeNumbersImgData.oData.spriteHeight * o)
                        }
                        var o = .5;
                        if (2 == l) {
                            var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].x,
                            ...
                            ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, n - s / 2 * o + 26, m - i / 2 * o - 12, s * o, i * o)
                        } else if (1 == l) {
                            var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup2].x,
                            ...
                            var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].x,
                                ...
                                s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].width,
                                i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].height;
                            ctx.drawImage(this.oUiElementsImgData.img, a, e + i - oGameData.gameId / 6 * i, s, Math.max(oGameData.gameId / 6 * i, .1), n - s / 2 * o + 26, m - i / 2 * o - 12 + (i - oGameData.gameId / 6 * i) * o - this.posY / 2, s * o, Math.max(oGameData.gameId / 6 * i, .1) * o)
                        }
                    }
                    break;
                case "gameIntro":
                    ...
                    var u = oGameData.gameId + 1,
                        D = 22,
                        p = 120,
                        c = u * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width,
                        I = Math.floor(u / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                    ctx.drawImage(this.oSmallNumbersImgData.img, c, I, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight, D, p - this.posY / 2, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight);
                    var u = 10,
                        c = u * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width,
                        I = Math.floor(u / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                    ctx.drawImage(this.oSmallNumbersImgData.img, c, I, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight, D + this.smallNumberSpace, p - this.posY / 2, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight);
                    var u = 6,
                        c = u * this.oSmallNumbersImgData.oData.spriteWidth % this.oSmallNumbersImgData.img.width,
                        I = Math.floor(u / (this.oSmallNumbersImgData.img.width / this.oSmallNumbersImgData.oData.spriteWidth)) * this.oSmallNumbersImgData.oData.spriteHeight;
                    ctx.drawImage(this.oSmallNumbersImgData.img, c, I, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight, D + 2 * this.smallNumberSpace, p - this.posY / 2, this.oSmallNumbersImgData.oData.spriteWidth, this.oSmallNumbersImgData.oData.spriteHeight);
                    var o = .8,
                    ...
                    if (ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, 5, 5 - this.posY / 2, s * o, i * o), this.cupFlipInc += 4 * delta, Math.floor(this.cupFlipInc) % 2 == 0) {
                        var f = 2,
                            a = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + f]].x,
                            e = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + f]].y,
                            s = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + f]].width,
                            i = this.oUiElementsImgData.oData.oAtlasData[oImageIds["cup" + f]].height,
                            v = oGameData.gameId + 1;
                    ...
                    var r = countryFlags.getBData(oGameData.userId),
                        o = 1.2;
                    ctx.drawImage(this.oCountryFlagsImgData.img, r.bX, r.bY, r.bWidth, r.bHeight, canvas.width / 2 - r.bWidth / 2 * o - 120, .6 * canvas.height - r.bHeight / 2 * o - this.posY / 4, r.bWidth * o, r.bHeight * o);
                    var r = countryFlags.getBData(oGameData.enemyId);
                    ctx.drawImage(this.oCountryFlagsImgData.img, r.bX, r.bY, r.bWidth, r.bHeight, canvas.width / 2 - r.bWidth / 2 * o + 120, .6 * canvas.height - r.bHeight / 2 * o - this.posY / 4, r.bWidth * o, r.bHeight * o);
                    break;
                case "game":
                    var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].x,
                    ...
                    for (var b = oGameData.userScore.toString(), h = 0; h < b.length; h++) {
                        var u = parseFloat(b.charAt(h)),
                            c = u * this.oScoreNumbersImgData.oData.spriteWidth % this.oScoreNumbersImgData.img.width,
                            I = Math.floor(u / (this.oScoreNumbersImgData.img.width / this.oScoreNumbersImgData.oData.spriteWidth)) * this.oScoreNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oScoreNumbersImgData.img, c, I, this.oScoreNumbersImgData.oData.spriteWidth, this.oScoreNumbersImgData.oData.spriteHeight, canvas.width / 2 - 24 + h * this.scoreNumberSpace - b.length * this.scoreNumberSpace / 2, 15 - this.posY / 2, this.oScoreNumbersImgData.oData.spriteWidth, this.oScoreNumbersImgData.oData.spriteHeight * this.userCardScale)
                    }
                    var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].x,
                        e = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].y,
                        s = this.oGameElementsImgData.oData.oAtlasData[oImageIds.scoreCard].width,
                    ...
                    for (var b = oGameData.enemyScore.toString(), h = 0; h < b.length; h++) {
                        var u = parseFloat(b.charAt(h)),
                            c = u * this.oScoreNumbersImgData.oData.spriteWidth % this.oScoreNumbersImgData.img.width,
                            I = Math.floor(u / (this.oScoreNumbersImgData.img.width / this.oScoreNumbersImgData.oData.spriteWidth)) * this.oScoreNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oScoreNumbersImgData.img, c, I, this.oScoreNumbersImgData.oData.spriteWidth, this.oScoreNumbersImgData.oData.spriteHeight, canvas.width / 2 + 19 + h * this.scoreNumberSpace - b.length * this.scoreNumberSpace / 2, 15 - this.posY / 2, this.oScoreNumbersImgData.oData.spriteWidth, this.oScoreNumbersImgData.oData.spriteHeight * this.enemyCardScale)
                    }
                    var r = countryFlags.getBData(oGameData.userId),
                        o = .7;
                    ctx.drawImage(this.oCountryFlagsImgData.img, r.bX, r.bY, r.bWidth, r.bHeight, canvas.width / 2 - r.bWidth / 2 * o - 80, 10 - this.posY, r.bWidth * o, r.bHeight * o);
                    var r = countryFlags.getBData(oGameData.enemyId);
                    if (ctx.drawImage(this.oCountryFlagsImgData.img, r.bX, r.bY, r.bWidth, r.bHeight, canvas.width / 2 - r.bWidth / 2 * o + 80, 10 - this.posY, r.bWidth * o, r.bHeight * o), firstRun) {
                        ctx.fillStyle = "rgba(0, 0, 0, 0.5)", ctx.fillRect(0, 0, canvas.width, canvas.height);
                        var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.tutScreen].x,
                        ...
                        var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + y]].x,
                        ...
                        if (ctx.drawImage(this.oGameElementsImgData.img, a, e, s, i, -s / 2, -i / 3, s, i), ctx.restore(), o = .4, this.ballY < 20) {
                            var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].x,
                        ...
                        o = .4;
                        var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].x,
                        ...
                        var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + y]].x,
                            ...
                            s = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + y]].width,
                            i = this.oGameElementsImgData.oData.oAtlasData[oImageIds["enemyBat" + y]].height;
                        ctx.drawImage(this.oGameElementsImgData.img, a, e, s, i, -s / 2, -i / 2, s, i), ctx.restore(), o = .4;
                        var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.finger].x,
                ...
                case "gameComplete":
                    ...
                    var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].x,
                        ...
                        s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].width,
                        i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.titleFadeBar].height;
                    if (ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, 0, .55 * canvas.height - i / 2 + this.posY / 2, canvas.width, i), justWonCup) {
                        var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].x,
                            e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].y,
                            s = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].width,
                            i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.cup3].height;
                        ...
                        var a = this.oUiElementsImgData.oData.oAtlasData[w].x,
                            e = this.oUiElementsImgData.oData.oAtlasData[w].y,
                            s = this.oUiElementsImgData.oData.oAtlasData[w].width,
                            i = this.oUiElementsImgData.oData.oAtlasData[w].height;
                        ctx.drawImage(this.oUiElementsImgData.img, a, e, s, i, canvas.width / 2 - s / 2, .2 * canvas.height - i / 2 - this.posY, s, i)
                    }
                    var a = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].x,
                        e = this.oUiElementsImgData.oData.oAtlasData[oImageIds.globeLogo].y,
                    ...
                    for (var b = oGameData.userScore.toString(), h = 0; h < b.length; h++) {
                        var u = parseFloat(b.charAt(h)),
                            c = u * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width,
                            I = Math.floor(u / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                        ctx.drawImage(this.oLargeNumbersImgData.img, c, I, this.oLargeNumbersImgData.oData.spriteWidth, this.oLargeNumbersImgData.oData.spriteHeight, canvas.width / 2 - 120 + h * this.largeNumberSpace - b.length * this.largeNumberSpace / 2, .55 * canvas.height - 10 - i / 2 - this.posY / 3, this.oLargeNumbersImgData.oData.spriteWidth, this.oLargeNumbersImgData.oData.spriteHeight)
                    }
                    var u = 12,
                        c = u * this.oLargeNumbersImgData.oData.spriteWidth % this.oLargeNumbersImgData.img.width,
                        I = Math.floor(u / (this.oLargeNumbersImgData.img.width / this.oLargeNumbersImgData.oData.spriteWidth)) * this.oLargeNumbersImgData.oData.spriteHeight;
                    ...
                    var r = countryFlags.getBData(oGameData.userId),
                        o = 1.2;
                    ctx.drawImage(this.oCountryFlagsImgData.img, r.bX, r.bY, r.bWidth, r.bHeight, canvas.width / 2 - r.bWidth / 2 * o - 120, .55 * canvas.height - 110 - r.bHeight / 2 * o - this.posY / 2, r.bWidth * o, r.bHeight * o);
                    var r = countryFlags.getBData(oGameData.enemyId);
                    ctx.drawImage(this.oCountryFlagsImgData.img, r.bX, r.bY, r.bWidth, r.bHeight, canvas.width / 2 - r.bWidth / 2 * o + 120, .55 * canvas.height - 110 - r.bHeight / 2 * o - this.posY / 2, r.bWidth * o, r.bHeight * o);
                    break;
                case "pause":
            ...
            "undefined" == typeof e && (e = 1), this.flareRot += delta;
            var s = Math.sin(1 * this.flareRot) / 2 / 3;
            ctx.save(), ctx.translate(t, a), ctx.rotate(this.flareRot), ctx.scale(e * (1 + s), e * (1 - s));
            var i = this.oUiElementsImgData.oData.oAtlasData[oImageIds.flare].x,
                ...
                h = this.oUiElementsImgData.oData.oAtlasData[oImageIds.flare].width,
                r = this.oUiElementsImgData.oData.oAtlasData[oImageIds.flare].height;
            ctx.drawImage(this.oUiElementsImgData.img, i, o, h, r, -h / 2, -r / 2, h, r), ctx.scale(1 * (1 - s), 1 * (1 + s)), ctx.scale(1 * (1 - s), 1 * (1 + s)), ctx.rotate(2 * -this.flareRot), ctx.drawImage(this.oUiElementsImgData.img, i, o, h, r, -h / 2, -r / 2, h, r), ctx.restore()
        }, t.prototype.addButs = function(t) {
            for (var a = 0; a < this.aButs.length; a++) {
                var e = this.posY,
                    s = 0;
                0 == this.incY || this.aButs[a].noMove || (s = 3 * Math.sin(this.incY + 45 * a)), this.aButs[a].scale || (this.aButs[a].scale = 1);
                ...
                t.drawImage(this.aButs[a].oImgData.img, i, o, h, r, n + this.aButs[a].aPos[0] - h / 2 * this.aButs[a].scale + e - s / 2, m + this.aButs[a].aPos[1] - r / 2 * this.aButs[a].scale + s / 2, h * this.aButs[a].scale + s, r * this.aButs[a].scale - s)
            }
        }, t
    }();
    t.Panel = a
    ...
    var a = function() {
        ...
        return t.prototype.update = function() {
            ...
            var e = Math.max(Math.min((this.x - this.prevX) / delta, 3500), -3500) / 3500,
                ...
                i = 0;
            return s < .5 && (e > .5 ? i = -(2 * (e - .5)) * (1 - 2 * s) : e < -.5 && (i = -(2 * (e + .5)) * (1 - 2 * s))), e *= t < 0 ? e > 0 ? 1 - t / 1 : 1.2 : e < 0 ? 1 + t / 1 : 1.2, 0 == ball.servingState && (e *= .5), this.hitX = e + .8 * t, this.hitY = .4 * (1 - s), {
                x: this.hitX,
                y: this.hitY,
            ...
            ctx.drawImage(this.oGameElementsImgData.img, t, a, e, s, -e / 2, -s / 3, e, s), ctx.rotate(-this.rotation), ctx.translate(0, Math.min(7 * Math.max((this.y - .5 * canvas.height) / (.5 * canvas.height), 0), 7)), ctx.rotate(this.rotation);
            var t = this.oGameElementsImgData.oData.oAtlasData[oImageIds.userBatEdge].x,
            ...
            ctx.drawImage(this.oGameElementsImgData.img, t, a, e, s, -e / 2, -s / 3 - 23, e, s), ctx.restore()
        }, t
    }();
    t.UserBat = a
}(Elements || (Elements = {}));
...
! function(t) {
    var a = function() {
        function t() {
            this.x = 0, this.y = 0, this.rotation = 0, this.scale = 1, this.speedX = 3e3, this.maxAcc = 500, this.skillLevel = 0, this.id = 0, this.aEases = new Array("Quad.easeInOut", "Back.easeOut", "Cubic.easeOut", "Back.easeInOut"), this.trackBall = !1, this.slideInc = 0, this.flailInc = 0, this.oGameElementsImgData = assetLib.getData("gameElements"), this.x = canvas.width / 2, this.targX = 0, this.targY = 0, this.accX = 0, this.id = (6 * oGameData.cupId + oGameData.gameId) % 7, 0 == oGameData.cupId ? this.skillLevel = (oGameData.gameId + 1) * (2.5 / 6) / 10 : this.skillLevel = (2.5 + 7.5 / 9 * (oGameData.cupId - 1) + (oGameData.gameId + 1) * (7.5 / 9 / 6)) / 10
        }
        return t.prototype.resetToCentre = function() {
            ...
            this.flailInc = 0;
            var a = 1;
            ball.x < this.x && (a = -1), TweenLite.to(this, .5, {
                flailInc: a,
                ease: "Quad.easeInOut",
                onComplete: function() {
                    TweenLite.to(t, .5, {
            ...
            if ((0 == e || 1 * Math.random() < .25) && 1 != ball.servingState) {
                ...
                var o = a * a * 235 * (1 + tableTop.offsetY / 2) / 2,
                    h = o * (tableTop.offsetX + .6 * t) * 1.28 * (1 + tableTop.offsetY / 2) + 233 * t / 2 + 100 * e;
            ...
            this.y = this.targY + canvas.height / 4 + 50 * tableTop.offsetY - 45, this.trackBall ? (this.x > ball.x + 15 ? this.slideInc = Math.max(this.slideInc - 1e3 * delta, -50 + -50 * this.skillLevel) : this.x < ball.x - 15 && (this.slideInc = Math.min(this.slideInc + 1e3 * delta, 50 + 50 * this.skillLevel)), this.x += 4 * this.slideInc * delta, "enemy" == ball.lastHit && (this.targX = this.x - canvas.width / 2, this.moveTween = TweenLite.to(this, (.35 * Math.random() + .3) * (1 + .5 * (1 - this.skillLevel)), {
            ...
            var e = 0;
            this.hitY < .8 && (this.hitX > .1 ? e = Math.random() * -1 * (.75 + .25 * this.skillLevel) : this.hitX < -.1 && (e = 1 * Math.random() * (.75 + .25 * this.skillLevel)));
            ...
            ctx.drawImage(this.oGameElementsImgData.img, t, a, e, s, -e / 2, -s / 3, e, s), ctx.restore()
        }, t
    }();
    t.EnemyBat = a
}(Elements || (Elements = {}));
...
! function(t) {
    var a = function() {
        ...
        return t.prototype.resetServe = function(t) {
            var a = this;
            this.servingState = 0, this.canHit = !1, enemyBat.resetToCentre(), tableTop.tweenToPos(0, 1, this.speed, this.lastHit, this.spin), this.lastHit = t, rallyHits = 0, this.x = -100, this.bounceNum = 0, this.ballShortState = 0, this.offTable = !1, this.offSide = !1, "user" == this.lastHit ? (this.tablePosX = 0, this.tablePosY = .9, this.height = 25, this.heightInc = 0, this.aTrailPoints = new Array, this.tableVX = 0, this.tableVY = 0) : (this.tablePosX = 0, this.tablePosY = .2, this.height = 15, this.heightInc = 0, this.aTrailPoints = new Array), this.servePosInc = 0, this.servePrepTween = TweenLite.to(this, .5, {
                servePosInc: 1,
                ease: "Quad.easeOut",
                onComplete: function() {
                    a.canHit = !0
            ...
            this.spin = t.spin, this.spinInc = 0, "enemy" == this.lastHit ? (this.targBounceX = t.x, this.targBounceY = t.y, this.speed = t.speed, tableTop.tweenToPos(this.targBounceX, this.targBounceY, this.speed, this.lastHit, this.spin), 0 == this.servingState ? (this.servingState = 1, this.heightInc = -(-2400 + 6 * this.height) * (.8 - this.speed) * 1.2, this.speed = (this.speed - .3) / 4 + .3) : this.heightInc = (-2400 + 6 * this.height) * (.8 - this.speed)) : (this.targBounceX = t.x, this.targBounceY = t.y, this.speed = t.speed, 0 == this.servingState ? (this.servingState = 1, this.heightInc = -(-2400 + 6 * this.height) * (.8 - this.speed) * 1.2, this.speed = (this.speed - .3) / 6 + .3) : this.heightInc = (-2400 + 6 * this.height) * (.8 - this.speed), tableTop.tweenToPos(0, 1, this.speed, this.lastHit, this.spin), enemyBat.setBouncePos(this.targBounceX, this.targBounceY, this.spin)), this.tableVX = (this.targBounceX - this.tablePosX) / (1.1 * (1 - this.speed)), this.tableVY = (this.targBounceY - this.tablePosY) / (1.1 * (1 - this.speed))
        }, t.prototype.update = function() {
            if (0 == this.servingState) "user" == this.lastHit ? (this.y = canvas.height / 4 + 50 * tableTop.offsetY + this.tablePosY * this.tablePosY * 235 * (1 + tableTop.offsetY / 2) + 100 * (1 - this.servePosInc), this.tablePosX = Math.min(Math.max((userBat.x - canvas.width / 2) / 300, -.95), .95), this.x = canvas.width / 2 + ((this.y - canvas.height / 4) * (tableTop.offsetX + .6 * this.tablePosX) * 1.28 * (1 + tableTop.offsetY / 2) + 233 * this.tablePosX / 2 + tableTop.offsetX * tableTop.sideMultiplier) + (1 - this.servePosInc) * -500, this.scale = .27 + (this.y - canvas.height / 4) / 600, this.canHit && userBat.getHitData(this.tablePosX, this.tablePosY).y < .4 && userBat.x > this.x - 80 * userBat.scale && userBat.x < this.x + 80 * userBat.scale && userBat.y > this.y - this.height * (3 * this.scale) - 16 - 80 * userBat.scale && userBat.y < this.y - this.height * (3 * this.scale) - 16 + 80 * userBat.scale && (this.bounceNum = 0, this.lastHit = "user", this.setBouncePoint(userBat.getHitData(this.tablePosX, this.tablePosY)))) : (this.y = canvas.height / 4 + 50 * tableTop.offsetY + this.tablePosY * this.tablePosY * 235 * (1 + tableTop.offsetY / 2) + 100 * (1 - this.servePosInc), this.tablePosX = 0, this.x = canvas.width / 2 + ((this.y - canvas.height / 4) * (tableTop.offsetX + .6 * this.tablePosX) * 1.28 * (1 + tableTop.offsetY / 2) + 233 * this.tablePosX / 2 + tableTop.offsetX * tableTop.sideMultiplier) + (1 - this.servePosInc) * -500, this.scale = .27 + (this.y - canvas.height / 4) / 600);
            else {
                if (this.offTable || ("user" == this.lastHit ? this.spinInc = Math.min(Math.max(this.spinInc + Math.pow(2.5 * this.spin, 3) * delta * (1 - this.tablePosY), -3), 3) : this.spinInc = Math.min(Math.max(this.spinInc + Math.pow(2 * this.spin, 3) * delta * this.tablePosY, -2), 2), this.tablePosX += (this.tableVX + this.spinInc) * delta, this.tablePosY += this.tableVY * delta), !this.offTable && "user" == this.lastHit && this.tablePosY < 0 && (this.offTable = !0, this.offTableVX = 10 * (this.x - this.aTrailPoints[0].x), this.offTableVY = 10 * (this.y - this.aTrailPoints[0].y), this.offTableTween && this.offTableTween.kill(), this.offTableTween = TweenLite.to(this, 2, {
                    ...
                    if (this.height = 0, this.heightInc *= -.85, 0 == this.ballShortState) {
                ...
                if ((this.offTable || this.offSide) && this.height <= -200) return updateScore("user" == this.lastHit ? 0 == this.bounceNum ? "enemy" : "user" : 0 == this.bounceNum ? "user" : "enemy"), ((oGameData.userScore + oGameData.enemyScore) % 2 == 0 || oGameData.userScore >= 10 && oGameData.enemyScore >= 10) && (this.serveFlip = !this.serveFlip), void(this.serveFlip ? this.resetServe("user") : this.resetServe("enemy"));
                this.oGameElementsImgData.oData.oAtlasData[oImageIds.table0].height;
                if (this.offTable ? (this.x += this.offTableVX * delta, this.y += this.offTableVY * delta) : (this.y = canvas.height / 4 + 50 * tableTop.offsetY + this.tablePosY * this.tablePosY * 235 * (1 + tableTop.offsetY / 2), this.x = canvas.width / 2 + (this.y - canvas.height / 4) * (tableTop.offsetX + .6 * this.tablePosX) * 1.28 * (1 + tableTop.offsetY / 2) + 233 * this.tablePosX / 2 + tableTop.offsetX * tableTop.sideMultiplier), this.scale = .27 + (this.y - canvas.height / 4) / 600, this.aTrailPoints.push({
                        ...
                        height: this.height,
                        scale: this.scale
                    }), this.aTrailPoints.length > 5 && this.aTrailPoints.shift(), this.y > canvas.height) return updateScore(this.bounceNum > 0 || this.ballShortState > 0 ? "enemy" : "user"), ((oGameData.userScore + oGameData.enemyScore) % 2 == 0 || oGameData.userScore >= 10 && oGameData.enemyScore >= 10) && (this.serveFlip = !this.serveFlip), void(this.serveFlip ? this.resetServe("user") : this.resetServe("enemy"));
                "enemy" == this.lastHit && (2 == this.servingState && 1 == this.bounceNum || 1 == this.servingState && 2 == this.bounceNum) && !(this.height < 0 && 0 == this.bounceNum) && this.tablePosY > .5 && userBat.x > this.x - 82 * userBat.scale && userBat.x < this.x + 82 * userBat.scale && userBat.y > this.y - this.height * (3 * this.scale) - 16 - 82 * userBat.scale && userBat.y < this.y - this.height * (3 * this.scale) - 16 + 82 * userBat.scale && (playSound("hit" + Math.floor(6 * Math.random())), rallyHits++, this.servingState = 2, this.bounceNum = 0, this.lastHit = "user", this.setBouncePoint(userBat.getHitData(this.tablePosX, this.tablePosY))), "user" == this.lastHit && (2 == this.servingState && 1 == this.bounceNum || 1 == this.servingState && 2 == this.bounceNum) && this.tablePosY < .5 && this.tablePosY > 0 && enemyBat.x > this.x - 70 * enemyBat.scale && enemyBat.x < this.x + 70 * enemyBat.scale && enemyBat.y > this.y - this.height * (3 * this.scale) - 16 - 70 * enemyBat.scale && enemyBat.y < this.y - this.height * (3 * this.scale) - 16 + 70 * enemyBat.scale && (playSound("hit" + Math.floor(6 * Math.random())), rallyHits++, this.servingState = 2, this.bounceNum = 0, this.lastHit = "enemy", this.setBouncePoint(enemyBat.getHitData(this.tablePosX, this.tablePosY)))
            }
        }, t.prototype.render = function() {
            ...
            var t = this.oGameElementsImgData.oData.oAtlasData[oImageIds.ball].x,
            ...
            ctx.drawImage(this.oGameElementsImgData.img, t, a, e, s, this.x - e / 2 * this.scale, this.y - s / 2 * this.scale - this.height * (3 * this.scale) - 16, e * this.scale, s * this.scale), "user" == this.lastHit && 0 == this.ballShortState && this.renderTrail()
            ...
            for (var t = Math.floor(this.aTrailPoints.length / .3 * (Math.max(Math.min(this.speed, .6), .3) - .3)), a = 0; a < t; a++) {
                ...
                var s = this.oGameElementsImgData.oData.oAtlasData[oImageIds["ballTrail" + e]].x,
                    ...
                    h = this.oGameElementsImgData.oData.oAtlasData[oImageIds["ballTrail" + e]].height;
                ctx.drawImage(this.oGameElementsImgData.img, s, i, o, h, this.aTrailPoints[e].x - o / 2 * this.aTrailPoints[e].scale, this.aTrailPoints[e].y - h / 2 * this.aTrailPoints[e].scale - this.aTrailPoints[e].height * (3 * this.aTrailPoints[e].scale) - 16, o * this.aTrailPoints[e].scale, h * this.aTrailPoints[e].scale)
            }
        }, t
    }();
    t.Ball = a
...
! function(t) {
    var a = function() {
        ...
        return t.prototype.bounce = function() {
            ...
            var r = .5;
            "enemy" == s && (r = .5, h = (1 - 2 * (a - .5)) * (.3 - (e - .3)) / .3), this.offsetTween = TweenLite.to(this, r, {
                offsetX: o,
                offsetY: h,
                ease: "Quad.easeOut"
            })
            ...
            ctx.drawImage(this.oGameElementsImgData.img, a, e, s, t, canvas.width / 2 - s / 2 * (1 + this.offsetY / 3) + this.offsetX * (.282 * this.segs) * 3 * (1 + this.offsetY / 3) + this.offsetX * this.sideMultiplier, this.netY + this.netHeight - 3 * (1 + this.offsetY / 3), s * (1 + this.offsetY / 3), t * (1 + this.offsetY / 3)), ctx.drawImage(this.oShadowImgData.img, 0, 0, this.oShadowImgData.img.width, this.oShadowImgData.img.height, canvas.width / 2 - this.oShadowImgData.img.width / 2 * (1 + this.offsetY / 3) + 100 * this.offsetX * 2.3 * (1 + this.offsetY / 3) + this.offsetX * this.sideMultiplier, canvas.height / 4 + this.oGameElementsImgData.oData.oAtlasData[oImageIds.table0].height * (1 + this.offsetY / 3.5) + 50 * this.offsetY - 80, this.oShadowImgData.img.width * (1 + this.offsetY / 3), this.oShadowImgData.img.height * (1 + this.offsetY / 3));
            var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableLegs].x,
            ...
            for (var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].x, e = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].y, s = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].width, t = this.oGameElementsImgData.oData.oAtlasData[oImageIds["table" + this.id]].height, i = 0; i < this.segs; i++) ctx.drawImage(this.oGameElementsImgData.img, a, e + t / this.segs * i, s, t / this.segs, canvas.width / 2 - s / 2 * (1 + this.offsetY / 3) + this.offsetX * (i * (100 / this.segs)) * 3 * (1 + this.offsetY / 3) + this.offsetX * this.sideMultiplier, canvas.height / 4 + t / this.segs * i * (1 + this.offsetY / 2) + 50 * this.offsetY, s * (1 + this.offsetY / 3), t / this.segs * (1 + this.offsetY / 2));
            var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].x,
            ...
            if (ctx.drawImage(this.oGameElementsImgData.img, a, e, s, t, canvas.width / 2 - s / 2 * (1 + this.offsetY / 3) + 100 * this.offsetX * 3 * (1 + this.offsetY / 3) + this.offsetX * this.sideMultiplier, canvas.height / 4 + this.oGameElementsImgData.oData.oAtlasData[oImageIds.table0].height * (1 + this.offsetY / 2) + 50 * this.offsetY, s * (1 + this.offsetY / 3), t * (1 + this.offsetY / 3)), this.bounceMarkScale > 0) {
                var a = this.oGameElementsImgData.oData.oAtlasData[oImageIds.bounceMark].x,
                    ...
                    o = canvas.height / 4 + 50 * this.offsetY + ball.bounceY * ball.bounceY * 235 * (1 + this.offsetY / 2),
                    h = canvas.width / 2 + (o - canvas.height / 4) * (this.offsetX + .6 * ball.bounceX) * 1.28 * (1 + this.offsetY / 2) + 233 * ball.bounceX / 2 + this.offsetX * this.sideMultiplier,
                    r = .27 + (o - canvas.height / 4) / 600;
                ctx.drawImage(this.oGameElementsImgData.img, a, e, s, t, h - s / 2 * (r * this.bounceMarkScale), o - t / 2 * (r * this.bounceMarkScale), s * (r * this.bounceMarkScale), t * (r * this.bounceMarkScale))
            }
    ...
    var a = function() {
        ...
        return t.prototype.createTextObjects = function() {
            ...
            for (var a, e = new Array, s = 0; s < t.length; s++) {
                a = 0;
                for (var i = 0; i < t[s].length; i++) a += parseInt(t[s][i]["@xadvance"]), 0 == i ? a -= parseInt(t[s][i]["@xoffset"]) : i == t[s].length - 1 && (a += parseInt(t[s][i]["@xoffset"]));
                e.push(a)
            }
            return e
            ...
            for (var e = new Array, s = 0; s < t.length; s++) {
                ...
                for (var i = 0; i < t[s].length; i++)
                    for (var o = 0; o < assetLib.textData["fontData" + a].text.chars["char"].length; o++) t[s][i].charCodeAt() == assetLib.textData["fontData" + a].text.chars["char"][o]["@id"] && e[s].push(assetLib.textData["fontData" + a].text.chars["char"][o])
            }
            return e
        }, t.prototype.renderText = function(t) {
            var a, e = this.oTextData[t.text].aLineData,
                s = this.oTextData[t.text].oFontImgData,
                i = 0,
                o = 0,
                h = 0,
                r = 1,
            ...
            var m = 1 * r;
            t.maxWidth && this.oTextData[t.text].blockWidth * r > t.maxWidth && (m = t.maxWidth / this.oTextData[t.text].blockWidth), t.anim && (this.inc += 7 * delta);
            for (var l = 0; l < e.length; l++) {
                a = 0, "centre" == t.alignX && (i = this.oTextData[t.text].aLineWidths[l] / 2), "centre" == t.alignY && (o = this.oTextData[t.text].blockHeight / 2 + h * (e.length - 1) / 2);
                for (var g = 0; g < e[l].length; g++) {
                    var d = e[l][g]["@x"],
                        u = e[l][g]["@y"],
                        c = e[l][g]["@width"],
                        I = e[l][g]["@height"];
                    t.anim && (n = Math.sin(this.inc + g / 2) * (I / 15 * m)), ctx.drawImage(s.img, d, u, c, I, t.x + (a + parseInt(e[l][g]["@xoffset"]) - i) * m, t.y + (parseInt(e[l][g]["@yoffset"]) + l * this.oTextData[t.text].lineHeight + l * h - o) * m + n, c * m, I * m), a += parseInt(e[l][g]["@xadvance"])
                }
            }
        }, t
    }();
...
! function(t) {
    var a = function() {
        function t(t, a) {
            "undefined" == typeof a && (a = !1), this.aAllCountryCodes = {
                0: "ES",
                1: "AU",
                2: "AT",
                3: "AG",
...
! function(t) {
    var a = function(t) {
        ...
        return __extends(a, t), a.prototype.update = function(a, e) {
...
! function(t) {
    var a = function() {
        ...
        return t.prototype.clearData = function() {
            ...
            for (var t = 0, a = 0; a < 10; a++) 7 == this.aLevelStore[a] && t++;
            return t
        }, t.prototype.getCurGameId = function() {
            for (var t = 0, a = 0; a < 10; a++) 0 != this.aLevelStore[a] && (t = this.aLevelStore[a] - 1);
            return t
        }, t.prototype.setGameData = function(t) {
            for (var a = 0; a < 10; a++) a < t.cupId ? this.aLevelStore[a] = 7 : a == t.cupId ? this.aLevelStore[a] = t.gameId + 1 : this.aLevelStore[a] = 0
...
var panel, background, totalScore = 0,
    ...
    oLogoBut, oImageIds = {},
    tableTop, userBat, enemyBat, ball, swipeState = 0,
    countryFlags = new Utils.CountryFlags(["CA", "CN", "CZ", "DK", "DE", "FR", "HK", "IN", "IE", "IT", "JP", "NL", "PL", "PT", "KR", "ES", "RU", "TR", "GB", "US"], (!1)),
    ...
    justWonCup = !1,
    controlState = 0,
    startTouchY, aEffects, rallyHits = 0,
    famobiPauseActive = !1;