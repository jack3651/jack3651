...
*/
    ...
    event: function(ev, msg){
		...
		case 'game_ready':   //game is ready 
            //gradle.showInter();
			break;
		
		case 'btn_play':   //Button Play trial
            //gradle.showInter();
			break;
		
		case 'btn_rules':   //Button Play queue
            //gradle.showInter();
			break;
				
		case 'btn_options':  //button Pause
			//gradle.checkInterval() && gradle.showInter();
			break;
		
		case 'btn_instructions': //btn home on the dialog game over
			//gradle.showInter();
			break;
