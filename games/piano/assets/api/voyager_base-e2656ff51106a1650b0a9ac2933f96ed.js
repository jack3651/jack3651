...
function(e, t, n) {
    ...
    function() {
        Softgames.prototype.ready = function(e) {
            ...
            var s, o, u = this;
            //return t = this._apiUrl(t, n), 
            return t = "./assets/4399.json",
                s = this, navigator.userAgent.toLowerCase().indexOf("android") >= 0 && e === "GET" && (t += "?android-buster=" + Math.random()), o = this._openXHR(e, t), o.setRequestHeader("Content-Type", "application/json-rpc"), o.setRequestHeader("Softgames-Voyager-Version", "2015-11-13 08:54:38 +0000"), o.onload = function() {
